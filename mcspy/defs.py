...
mix_descriptions = dict(
  ...
  T_qual_description=OrderedDict(
    (
      ...
      (
        1,
        ("1 = successful limb and surface retrieval (no near surface "
         + "atmosphere)."),
      ),
      (
        2,
        ("2 = successful limb retrieval (no surface or near surface "
         + "atmosphere)."),
      ),
      (
        3,
        ("3 = truncated limb retrieval (profile stops well above the "
         + "surface)."),
      ),
    )
  ),
  ...
  obs_qual_description=OrderedDict(
    (
      ...
      (
        1,
        ("1 = Limb staring observations (reduced calibration quality), "
         + "forward in-track viewing (178 <= Azimuth <= 182 deg), "
         + "retrieved in 1-D."),
      ),
      (
        2,
        ("2 = Standard observations, right forward off-track "
         + "viewing (182 deg < Azimuth < 260 deg), retrieved in 1-D."),
      ),
      (
        3,
      ...
      (
        4,
        ("4 = Standard observations, left forward off-track viewing "
         + "(90 deg < Azimuth < 178 deg), retrieved in 1-D."),
      ),
      (
        5,
        ("5 = Standard observations, left cross-track viewing (Azimuth "
      ...
      (
        10,
        ("10 = Standard observations, forward in-track viewing (178 "
         + "deg <= Azimuth <= 182 deg), retrieved in 2-D."),
      ),
      (
        11,
