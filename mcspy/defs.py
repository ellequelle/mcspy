...
mix_tab_ref_dt_cols = ['ref_date_0', 'ref_utc_0', 'ref_date_1',
    'ref_utc_1', 'ref_date_2', 'ref_utc_2', 'ref_date_3',
    'ref_utc_3', 'ref_date_4', 'ref_utc_4', 'ref_date_5',
    'ref_utc_5', 'ref_date_6', 'ref_utc_6', 'ref_date_7',
    'ref_utc_7', 'ref_date_8', 'ref_utc_8', 'ref_date_9',
    'ref_utc_9']
mix_tab_ref_sclk_cols = ['ref_sclk_0', 'ref_sclk_1', 'ref_sclk_2',
    'ref_sclk_3', 'ref_sclk_4', 'ref_sclk_5', 'ref_sclk_6',
    'ref_sclk_7', 'ref_sclk_8', 'ref_sclk_9']
mix_tab_int_cols = ['orb_num', 'Gqual', 'Rqual', 'P_qual', 'T_qual', 
    'dust_qual', 'H2Ovap_qual', 'H2Oice_qual', 'CO2ice_qual',
    'surf_qual', 'obs_qual']
mix_tab_real_cols = (['SCLK', 'Ls', 'solar_dist', 'solar_lat',
    'solar_lon', 'solar_zen', 'LST', 'lat', 'lon', 'profile_rad',
    'profile_alt', 'limb_ang', 'are_rad', 'surf_lat', 'surf_lon',
    'surf_rad', 'T_surf', 'T_surf_err', 'T_near_surf',
    'T_near_surf_err', 'dust_column', 'Dust_column_err',
    'H2Ovap_column', 'H2Ovap_column_err', 'H2Oice_column',
    'H2Oice_column_err', 'CO2ice_column', 'CO2ice_column_err',
    'p_surf', 'p_surf_err', 'p_ret_alt', 'p_ret', 'p_ret_err']
...
mix_date_col_lookup = {'datetime':['date', 'UTC'],
...
mix_date_cols = (['date', 'datetime'] + mix_tab_ref_dt_cols[0::2] +
            list(mix_date_col_lookup.keys()))
mix_time_cols = ['UTC'] + mix_tab_ref_dt_cols[1::2]
mix_new_cols = ['datetime', 'MY']
mix_data_cols = ['date', 'UTC', 'SCLK', 'Ls', 'solar_dist',
    'orb_num', 'solar_lat', 'solar_lon', 'solar_zen',
    'LST', 'lat', 'lon', 'profile_rad', 'profile_alt', 'limb_ang',
    'are_rad', 'surf_lat', 'surf_lon', 'surf_rad', 'T_surf',
    'T_surf_err', 'T_near_surf', 'T_near_surf_err', 'dust_column',
    'Dust_column_err', 'H2Ovap_column', 'H2Ovap_column_err',
    ...
    'CO2ice_column_err', 'p_surf', 'p_surf_err', 'p_ret_alt',
    'p_ret', 'p_ret_err']
mix_qual_cols = ['Rqual', 'P_qual', 'T_qual', 'dust_qual',
    'H2Ovap_qual', 'H2Oice_qual', 'CO2ice_qual', 'surf_qual',
    'obs_qual', 'Gqual']
mix_use_cols = ['datetime', 'MY', 'SCLK', 'Ls', 'solar_dist',
    'orb_num', 'solar_lat', 'solar_lon', 'solar_zen',
    'LST', 'lat', 'lon', 'profile_rad', 'profile_alt', 'limb_ang',
    'are_rad', 'surf_lat', 'surf_lon', 'surf_rad', 'T_surf',
    'T_surf_err', 'T_near_surf', 'T_near_surf_err', 'dust_column',
    ...
    'H2Oice_column', 'H2Oice_column_err', 'CO2ice_column',
    'CO2ice_column_err', 'p_surf', 'p_surf_err', 'p_ret_alt',
    'p_ret', 'p_ret_err'] + mix_qual_cols
mix_keep_cols = mix_use_cols
mix_cols = mix_use_cols
#mix_keep_cols = ['date', 'UTC', 'SCLK', 'Ls', 'solar_dist',
#    'orb_num', 'LST', 'lat', 'lon', 'datetime', 'MY', 'cLs',
#    'are_rad', 'surf_rad', 'surf_qual']
#['date', 'UTC', 'SCLK', 'Ls', 'solar_dist',
    #'orb_num', 'LST', 'lat', 'lon', 'datetime', 'MY', 
    #'are_rad', 'surf_rad']
prof_cols = ['temperature', 'T_err', 'dust', 'dust_err',
    'H2Oice', 'H2Oice_err', 'altitude', 'lat', 'lon']

mix_descriptions = dict(
    rad_qual_description = OrderedDict((
        (None, 'Radiance Quality Flag'),
        )),
    p_qual_description = OrderedDict((
        (None, 'Pressure retrieval quality flag.'),
        (0, '0 = successful pressure retrieval.'),
        (9, '9 = pressure not retrieved, pressure scale is based on climatological surface pressure.'),
        )),
    T_qual_description = OrderedDict((
        (None, 'Vertical extent of the temperature retrieval.'),
        (0, '0 = successful limb and nadir retrieval (coverage to the surface).'),
        (1, '1 = successful limb and surface retrieval (no near surface atmosphere).'),
        (2, '2 = successful limb retrieval (no surface or near surface atmosphere).'),
        (3, '3 = truncated limb retrieval (profile stops well above the surface).'),
        )),
    ...
    CO2ice_qual_description = OrderedDict((
        (None, 'CO2 ice retrieval quality flag.'),
        (9, '9 = not retrieved.')
        )),
    ...
    obs_qual_description = OrderedDict((
        (None, 'Quality and viewing direction of the observations used for the retrieval.'),
        (0, '0 = Standard observations, forward in-track viewing (178 deg <= Azimuth <= 182 deg), retrieved in 1-D.'),
        (1, '1 = Limb staring observations (reduced calibration quality), forward in-track viewing (178 <= Azimuth <= 182 deg), retrieved in 1-D.'),
        (2, '2 = Standard observations, right forward off-track viewing (182 deg < Azimuth < 260 deg), retrieved in 1-D.'),
        (3, '3 = Standard observations, right cross-track viewing (260 deg <= Azimuth < 290 deg), retrieved in 1-D.'),
        (4, '4 = Standard observations, left forward off-track viewing (90 deg < Azimuth < 178 deg), retrieved in 1-D.'),
        (5, '5 = Standard observations, left cross-track viewing (Azimuth = 90 deg), retrieved in 1-D.'),
        (6, '6 = Standard observations, left aft off-track viewing (2 deg < Azimuth < 90 deg), retrieved in 1-D.'),
        (7, '7 = Standard observations, aft in-track viewing (-4 deg <= Azimuth <= 2 deg), retrieved in 1-D.'),
        (10, '10 = Standard observations, forward in-track viewing (178 deg <= Azimuth <= 182 deg), retrieved in 2-D.'),
        (11, '11 = Limb staring observations (reduced calibration quality), forward in-track viewing (178 <= Azimuth <= 182 deg), retrieved in 2-D.'),
        (17, '17 = Standard observations, aft in-track viewing (-4 deg <= Azimuth <= 2 deg), retrieved in 2-D.'),
        ))
    )
